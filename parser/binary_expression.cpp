...
const std::vector<reaver::vapor::lexer::_v1::token_type> & reaver::vapor::parser::_v1::binary_operators()
{
...
const std::unordered_map<reaver::vapor::lexer::_v1::token_type, std::size_t> & reaver::vapor::parser::_v1::binary_operator_precedences()
{
...
reaver::vapor::parser::_v1::binary_expression reaver::vapor::parser::_v1::parse_binary_expression(reaver::vapor::parser::_v1::context & ctx,
    reaver::vapor::parser::_v1::expression lhs)
{
...
void reaver::vapor::parser::_v1::print(const reaver::vapor::parser::_v1::binary_expression & expr, std::ostream & os, std::size_t indent)
{
