...
MAYFLY_ADD_TESTCASE("basic postfix-expression",
    test(UR"(foo;)",
        postfix_expression{ { 0, 3 }, id_expression{ { 0, 3 }, { { lexer::token_type::identifier, UR"(foo)", { 0, 3 } } } }, {}, {} },
        [](auto && ctx) { return parse_postfix_expression(ctx); }));

MAYFLY_ADD_TESTCASE("argumentless",
    test(UR"(foo();)",
        postfix_expression{ { 0, 5 },
            id_expression{ { 0, 3 }, { { lexer::token_type::identifier, UR"(foo)", { 0, 3 } } } },
            lexer::token_type::round_bracket_open,
            {} },
        [](auto && ctx) { return parse_postfix_expression(ctx); }));

MAYFLY_ADD_TESTCASE("one argument",
    test(UR"(foo[1];)",
...
MAYFLY_ADD_TESTCASE("more arguments",
    test(UR"(foo{ a, b, c };)",
        postfix_expression{ { 0, 14 },
            ...
            { { { 5, 6 }, postfix_expression{ { 5, 6 }, id_expression{ { 5, 6 }, { { lexer::token_type::identifier, UR"(a)", { 5, 6 } } } }, {}, {} } },
                { { 8, 9 }, postfix_expression{ { 8, 9 }, id_expression{ { 8, 9 }, { { lexer::token_type::identifier, UR"(b)", { 8, 9 } } } }, {}, {} } },
                { { 11, 12 },
                    postfix_expression{ { 11, 12 }, id_expression{ { 11, 12 }, { { lexer::token_type::identifier, UR"(c)", { 11, 12 } } } }, {}, {} } } } },
        [](auto && ctx) { return parse_postfix_expression(ctx); }));
